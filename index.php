...
<?php
    ...
    add_action( 'my_hook', 'print_hello', 10, 2); //створюємо собитіє

   do_action( 'my_hook', 'dear customer', 'Volodymy ' ); //виконати нашу дію

   //<!-- Створення хука фільтра які дозволяють щось фільтрувати на сторінці -->

   function my_filter_function($str) { // тут щось буде вертатись
        return 'Hello ' . $str;
   };
   ...
   //Як позбутися хука коли він виповнив свою задачу
